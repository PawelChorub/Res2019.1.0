        ...
        private void SectionFill(string labelName, string dateOfAppointment)
        {
            try
            {
                ...
                foreach (AppointmentDetails appointmentDetails in businessLogic.ReadListOfAppointments(dateOfAppointment))
                {
                    ...
                    this.Controls[labelName + labelNumber].Text = appointmentDetails.CustomerForename + " " + appointmentDetails.CustomerSurname + " " + appointmentDetails.Name + " " + appointmentDetails.CustomerTelephoneNumber;
